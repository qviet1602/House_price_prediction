...
def scrape_bestplaces():
    ...
    try:
        ...
        for i in range(total):
            ...
            url = "https://www.bestplaces.net/crime/zip-code/" + state + "/" + city + "/" + info.get_zipcode()
            print("URL: ", url, " i:", i)
            ...
            if html_page.status_code == 200:
                ...
                if not is_oops:
                    ...
                    property_crime = item2_more_children[0][property_crime_index + 3:-1]
                    crime_data_csv_file.write(info.get_state())
                    crime_data_csv_file.write(",")
                    crime_data_csv_file.write(info.get_city())
                    crime_data_csv_file.write(",")
...
def get_urls():
    ...
    for info in url_info_list:
        url = "https://www.bestplaces.net/crime/zip-code/" + info.get_state() + "/" + info.get_city() + "/" + info.get_zipcode()
        url_list.append(url)
