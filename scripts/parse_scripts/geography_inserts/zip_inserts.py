all_files = ["./data/ZRI/allSummary/Zip_Zri_AllHomesPlusMultifamily_Summary.csv",
...
for each_file in all_files:
    ...
    with open(each_file, "r", encoding="latin-1") as csv_file:
        ...
        for line in csv_file:
            ...
            zipcode_combo = state_code + "::" + county_name + "::" + city_name + "::" + zipcode
...
for each_combo in zips:
    ...
    insert_line = "INSERT INTO zipcode(state_id, county_id, city_id, zip_code) values(" \
                  + construct_state_select(state_code) + \
                  "," + construct_county_select(county_name, state_code) + \
                  "," + construct_city_select(city_name, county_name, state_code) + ",'" + zipcode + "');"
    insert_lines.append(insert_line)
