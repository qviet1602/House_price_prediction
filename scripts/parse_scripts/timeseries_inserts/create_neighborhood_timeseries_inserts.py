...
def condo():
    insert_lines = []
    month_year_list = []
    with open("data/ZHVI/condoCoOpTimeSeries/Neighborhood_Zhvi_Condominum.csv", "r") as csv_file:
        line_count = 0
...
def oneBedroom():
    ...
    with open("data/ZHVI/oneBedroomTimeSeries/Neighborhood_Zhvi_1bedroom.csv", "r") as csv_file:
        line_count = 0
        for line in csv_file:
            line = line.rstrip("\n")
            line_parts = break_into_line_parts(line)
...
def twoBedroom():
    ...
    with open("data/ZHVI/twoBedroomTimeSeries/Neighborhood_Zhvi_2bedroom.csv", "r") as csv_file:
        line_count = 0
        for line in csv_file:
            line = line.rstrip("\n")
            line_parts = break_into_line_parts(line)
...
def threeBedroom():
    ...
    with open("data/ZHVI/threeBedroomTimeSeries/Neighborhood_Zhvi_3bedroom.csv", "r", encoding="latin-1") as csv_file:
        line_count = 0
        for line in csv_file:
            line = line.rstrip("\n")
            line_parts = break_into_line_parts(line)
...
def fourBedroom():
    ...
    with open("data/ZHVI/fourBedroomTimeSeries/Neighborhood_Zhvi_4bedroom.csv", "r") as csv_file:
        line_count = 0
        for line in csv_file:
            line = line.rstrip("\n")
            line_parts = break_into_line_parts(line)
...
def fivePlusBedroom():
    ...
    with open("data/ZHVI/fivePlusBedroomTimeSeries/Neighborhood_Zhvi_5BedroomOrMore.csv", "r") as csv_file:
        line_count = 0
        for line in csv_file:
            line = line.rstrip("\n")
            line_parts = break_into_line_parts(line)
...
def singleFamilyHome():
    ...
    with open("data/ZHVI/singleFamilyHomeTimeSeries/Neighborhood_Zhvi_SingleFamilyResidence.csv", "r", encoding="latin-1") as csv_file:
        line_count = 0
        for line in csv_file:
            line = line.rstrip("\n")
            line_parts = break_into_line_parts(line)
    ...
    sql_file = open("data/neighborhood_singleFamilyResidence_timeseries_insert.sql", "a")
