...
def multiFamily():
    insert_lines = []
    month_year_list = []
    with open("data/ZRI/multiFamilyTimeSeries/State_Zri_MultiFamilyResidenceRental.csv", "r") as csv_file:
        line_count = 0
    ...
    sql_file = open("data/state_rental_multiFamily_timeseries_insert.sql", "a")
...
def singleFamily():
    insert_lines = []
    month_year_list = []
    with open("data/ZRI/sFRTimeSeries/State_Zri_SingleFamilyResidenceRental.csv", "r") as csv_file:
        line_count = 0
        for line in csv_file:
            line = line.rstrip("\n")
            line_parts = line.split(",")
    ...
    sql_file = open("data/state_rental_singleFamily_timeseries_insert.sql", "a")
