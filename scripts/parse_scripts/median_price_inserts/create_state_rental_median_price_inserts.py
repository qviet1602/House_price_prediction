...
process_data("data/rentalListings/medianRentListPrice_1bedroom/State_MedianRentalPrice_1Bedroom.csv",
          "oneBedroom", "data/state_rental_median_price_1bedroom_insert.sql")

process_data("data/rentalListings/medianRentListPrice_2bedroom/State_MedianRentalPrice_2Bedroom.csv",
          "twoBedroom", "data/state_rental_median_price_2bedroom_insert.sql")

process_data("data/rentalListings/medianRentListPrice_3bedroom/State_MedianRentalPrice_3Bedroom.csv",
          "threeBedroom", "data/state_rental_median_price_3bedroom_insert.sql")

process_data("data/rentalListings/medianRentListPrice_4bedroom/State_MedianRentalPrice_4Bedroom.csv",
          "fourBedroom", "data/state_rental_median_price_4bedroom_insert.sql")

process_data("data/rentalListings/medianRentListPrice_5PlusBedroom/State_MedianRentalPrice_5BedroomOrMore.csv",
          "fivePlusBedroom", "data/state_rental_median_price_5bedroom_insert.sql")

process_data("data/rentalListings/medianRentListPrice_condoCoop/State_MedianRentalPrice_CondoCoop.csv",
          "condoCoOp", "data/state_rental_median_price_condo_insert.sql")

process_data("data/rentalListings/medianRentListPrice_duplexTriplex/State_MedianRentalPrice_DuplexTriplex.csv",
          "duplexTriplex", "data/state_rental_median_price_duplexTriplex_insert.sql")

process_data("data/rentalListings/medianRentListPrice_multiFamily/State_MedianRentalPrice_Mfr5Plus.csv",
          "multiFamilyResidenceRental", "data/state_rental_median_price_multiFamilyResidenceRental_insert.sql")

process_data("data/rentalListings/medianRentListPrice_sfrCondoCoop/State_MedianRentalPrice_AllHomes.csv",
          "all", "data/state_rental_median_price_all_insert.sql")

process_data("data/rentalListings/medianRentListPrice_singleFamilyResidence/State_MedianRentalPrice_Sfr.csv",
          "singleFamilyResidenceRental", "data/state_rental_median_price_singleFamilyResidenceRental_insert.sql")

process_data("data/rentalListings/medianRentListPrice_studio/State_MedianRentalPrice_Studio.csv",
          "studio", "data/state_rental_median_price_studio_insert.sql")