        ...
        for line in csv_file:
            ...
            for idx in range(6, len(line_parts), 1):
                if line_parts[idx].strip('"') != "":
                    ...
                    insert_line = (
                        "INSERT INTO county_median_price (county_id, home_type_id, year_month, list_price)"
                        + " VALUES("
                        + county_select
                        + ","
                        + home_type_select
...
process_data(
    ...
    "data/county_rental_median_price_singleFamilyResidenceRental_insert.sql",
)

process_data(
    "data/rentalListings/medianRentListPrice_studio/County_MedianRentalPrice_Studio.csv",
    "studio",
    "data/county_rental_median_price_studio_insert.sql",
)
