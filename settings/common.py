"""Django settings for domicilian project.
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "domicilian.users.auth.backends.UserTokenAuthentication",
...
SITE_NAME = env("SITE_NAME", default="domicilian")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="domicilian")
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "domicilian.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "domicilian.base.views.csrf_failure"
...
def get_release():
    ...
    release = domicilian.__version__
    try:
