...
var promises = [
  ...
  d3.json('/api/state_data_purchase/'),
];
...
function ready([state_list, state_data]) {
	...
	all_rectangles = d3.selectAll("rect");
		...
		if(d['name'] != null && d['id'] != null && d['id'] == 23) {
...
function draw_barChart(state_data) {
    ...
    .style("fill", "#69a3b2");
        ...
        //Draw the bar chart
        condoCoOp_data_every_5years = []

        for(var i=0; i<condoCoOp_data.length; i++) {
            each_year_data = condoCoOp_data[i]
            year = parseInt(each_year_data.year)
            current_dict = {}
            if(year % 5 == 0 || year == 2019) {
                current_dict['year'] = year
                current_dict['list_price'] = each_year_data.list_price;
                condoCoOp_data_every_5years.push(current_dict)
            }
        }

        oneBedroom_data_every_5years = []
        ...
        for(var i=0; i<oneBedroom_data.length; i++) {
            ...
            if(year % 5 == 0 || year == 2019) {
                current_dict['year'] = year
                current_dict['list_price'] = each_year_data.list_price;
                oneBedroom_data_every_5years.push(current_dict)
            }
        }

        twoBedroom_data_every_5years = []
        ...
        for(var i=0; i<twoBedroom_data.length; i++) {
            ...
            if(year % 5 == 0 || year == 2019) {
                current_dict['year'] = year
                current_dict['list_price'] = each_year_data.list_price;
                twoBedroom_data_every_5years.push(current_dict)
            }
        }

        threeBedroom_data_every_5years = []
        ...
        for(var i=0; i<threeBedroom_data.length; i++) {
            ...
            if(year % 5 == 0 || year == 2019) {
                current_dict['year'] = year
                current_dict['list_price'] = each_year_data.list_price;
                threeBedroom_data_every_5years.push(current_dict)
            }
        }

        fourBedroom_data_every_5years = []
        ...
        for(var i=0; i<fourBedroom_data.length; i++) {
            ...
            if(year % 5 == 0 || year == 2019) {
                current_dict['year'] = year
                current_dict['list_price'] = each_year_data.list_price;
                fourBedroom_data_every_5years.push(current_dict)
            }
        }

        fivePlusBedroom_data_every_5years = []
        ...
        for(var i=0; i<fivePlusBedroom_data.length; i++) {
            ...
            if(year % 5 == 0 || year == 2019) {
                current_dict['year'] = year
                current_dict['list_price'] = each_year_data.list_price;
                fivePlusBedroom_data_every_5years.push(current_dict)
            }
        }

        var colors = d3.schemeCategory10;

        var colorScheme = {'2000': colors[0], '2005': colors[1],
                        '2010': colors[2], '2015' : colors[3], '2019' : colors[4]}

        each_band_section = x_axisScale.bandwidth()/5
        last_x_value = 0

        chart3_svg.selectAll(".condoCoOpbar")
                   .data(condoCoOp_data_every_5years)
                   .enter().append("rect")
        ...
        chart3_svg.selectAll(".oneBedroombar")
                   .data(oneBedroom_data_every_5years)
                   .enter().append("rect")
        ...
        chart3_svg.selectAll(".twoBedroombar")
                   .data(twoBedroom_data_every_5years)
                   .enter().append("rect")
        ...
        chart3_svg.selectAll(".threeBedroombar")
                   .data(threeBedroom_data_every_5years)
                   .enter().append("rect")
        ...
        chart3_svg.selectAll(".fourBedroombar")
                   .data(fourBedroom_data_every_5years)
                   .enter().append("rect")
        ...
        chart3_svg.selectAll(".fiveBedroombar")
                   .data(fivePlusBedroom_data_every_5years)
                   .enter().append("rect")
                   ...
                   .attr("y", function(d) {
                            return y_axisScale(parseInt(d.list_price)) - bottom_margin;
                   })
                   .attr("width", function(d) {
                           return each_band_section - 1;
                   } )
        ...
        //Draw the legend
        var legend_names = ['2000', '2005', '2010','2015', '2019']
