...
def celery():
    ...
    install_requirements()
    migrate()
    local("celery worker -A domicilian -B -l INFO")
...
def qa():
    ...
    env.remote = "origin"
    env.branch = "qa"
    env.hosts = ["qa.domicilian.com"]
    env.dotenv_path = "/home/ubuntu/qa/domicilian/.env"
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = "origin"
    env.branch = "prod"
    env.hosts = ["prod.domicilian.com"]
    env.dotenv_path = "/home/ubuntu/prod/domicilian/.env"
    env.config_setter = fab.run
